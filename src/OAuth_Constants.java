public class OAuth_Constants {
    ...
    public static final String REDIRECT_URI = "https://novosibirsk.hh.ru";//uri для перенаправления пользователя после авторизации(не обязателен)
    ...
    public static final String PROTECTED_RESOURCE_URL = "https://api.hh.ru/me";
