...
public class OAuth_Constants {
    ...
    public static final String PROTECTED_RESOURCE_URL = "https://novosibirsk.hh.ru/search/vacancy?text=&specialization=1&area=4&salary=&currency_code=RUR&experience=doesNotMatter&order_by=relevance&search_period=&items_on_page=100&no_magic=true";
    public static final String REDIRECT_URL = "https://novosibirsk.hh.ru";
    public static final String USER_ID = "16646808";
    public static final String name_vac_node = "vacancy-name";
    ...
    public static final String payment_vac_node = "vacancy-salary";
