...
public class Main_GUI extends javax.swing.JFrame {
    ...
    private void initCombo(){
        fillCombo(jComboBox1, (new Areas()).getArea());
        fillCombo(jComboBox2, (new Specialization()).getSpec());
    }
    
    //show table
    private void show_table(String sql){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Профобласть");

        jButton1.setText("Обновить базу");
        ...
        jButton2.setText("Получить данные из БД");
        ...
        jLabel3.setText("Название вакансии");

        jLabel4.setText("Дата добавления");
        ...
        jButton3.setText("Показать все вакансии из БД");
...
//show array from db
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       method.fillArray(vac);
       addVac_to_fields(vac.get(0));
    }//GEN-LAST:event_jButton2ActionPerformed
//show all data from db
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        method.fillArray(vac);
        for(Vacancy iter : vac){
        jTextArea1.append(iter.toString());
        jTextArea1.append("\n");
        }
    }//GEN-LAST:event_jButton3ActionPerformed
    
    private void addVac_to_fields(Vacancy item){
        jTextField1.setText(item.getName());
        jTextField2.setText(item.getDate());
        jTextField3.setText(item.getOrganization());
        jTextField1.setText(item.getPayment());
    }
    
//fill combo
    private void fillCombo(JComboBox box, Map<Double, String> map){
